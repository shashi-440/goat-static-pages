...
import TitleStamp from "../../../AboutUsV2/components/TitleStamp/TitleStamp";
    ...
    <section className={styles.hero}>
      <div className={styles.header}>
        ...
        <Reveal as="p" className={styles.subtitle} delay={120}>
          Helping students find a place to call home before they even arrive
        </Reveal>
      </div>
      ...
      <div ref={mediaRef} className={`${styles.media} ${mediaShown ? styles.mediaShown : ""}`}>
        <Image
          src={heroImg}
          alt="Students settling into their new home together"
...
export default wrapperHOC(Hero, {
  componentName: "Hero-HowItWorksV2",
  showForChina: true,
});
